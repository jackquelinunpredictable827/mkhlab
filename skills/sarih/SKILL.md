---
name: sarih
description: "فلترة المحتوى العربي — اكتشف المحتوى السام والكراهية والسبام بـ5 لهجات عربية. يعمل بدون إنترنت. استخدم لفحص النصوص أو تنظيف بيانات."
metadata: {"openclaw": {"emoji": "🛡️", "requires": {"bins": ["sarih"]}}}
---
