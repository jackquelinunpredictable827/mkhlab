---
name: bidi-guard
description: "حماية من هجمات Trojan Source — اكتشف حروف Unicode الاتجاهية المخفية في الكود (CVE-2021-42574). استخدم لفحص الكود المصدري أمنياً."
metadata: {"openclaw": {"emoji": "🔒", "requires": {"bins": ["bidi-guard"]}}}
---
